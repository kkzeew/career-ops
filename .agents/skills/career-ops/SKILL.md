...
user-invocable: true
argument-hint: "[fit | scan | deep | pdf | offer | offers | apply | batch | tracker | pipeline | contact | training | project | interview-prep | update]"
license: MIT
---
...
Available commands:
  ...
  /career-ops fit       → Quick fit check: background + culture + HR impression (no report/PDF)
...
Applies to: `tracker`, `deep`, `interview-prep`, `training`, `project`, `patterns`, `followup`, `fit`
