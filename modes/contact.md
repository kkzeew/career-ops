...
4. **Generate message** with 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: A fact that answers their screening questions before they ask them (e.g. "5 years building ML pipelines, currently in Berlin, available immediately")
   ...
   - **Sentence 2 (Proof)**: Candidate's greatest quantifiable achievement demonstrating they've solved similar problems
